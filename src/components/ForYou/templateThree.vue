<template>
        ...
        <div class="col-2 clkhead">
          ...
          <div class="component-wrapper" id="column1">
            ...
            >
              <img
                class="image"
                :src="require(`../../assets/clock/${image.src}`)"
                draggable="true"
  ...
  export default {
    ...
    methods: {
      addQuestion() {
        this.$router.push(
          `/assignment/${this.$route.params.chapterId}/templateThree/${this.$route.params.id}/addquestion`
        );
      },
        ...
        this.column2Images.forEach((set) => {
          ...
          if (set.id && set.aid) {
            ...
            if (questionID === answerID) {
              score = score + 2;
              // this.correctAnsweredID.push(set.questionOriginalID)
