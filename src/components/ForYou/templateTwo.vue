<template>
      ...
      <div class="main-container">
        <div class="col-2 clkhead">
          ...
          <div class="component-wrapper" id="column1">
            <div
            v-for="(question, index) in setQuestions"
            :key="index"
        ...
        <div class="col-8 quehead">
          ...
          <div id="column2">
            <div class="btn-container">
              ...
              <button  v-if="role === 'teacher'" @click="addQuestion()">Add Question</button>
            </div>
            ...
            <div class="result-btn">
              ...
              <button @click="getResult()">Get Result</button></div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      addQuestion() {
        this.$router.push(
          `/assignment/${this.$route.params.chapterId}/templateTwo/${this.$route.params.id}/addquestion`
        );
      },
      ...
      onDragStart(event, index) {
        this.setIndex = index;
        console.log(event.target.src, ">>",this.setIndex,'this.setIndex ');
        event.dataTransfer.setData("text/plain", event.target.src);
        console.log(
          event.dataTransfer.setData("text/plain", event.target.src),
          ">>"
      ...
      onDrop(event, key) {
        ...
        console.log(this.setQuestions[this.setIndex], ">>this.setIndex111");
        ...
        this.column2Images[key].src = this.setQuestions[this.setIndex].src;
        this.column2Images[key].id = this.setQuestions[this.setIndex].id;

        this.column2Images[key].questionOriginalID = this.setQuestions[this.setIndex].questionOriginalID
      console.log(this.setQuestions[this.setIndex], "this.setQuestions[this.setIndex]");
        ...
        // this.column2Images[key].id = this.setQuestions[this.setIndex].id;
        // // console.log(this.column2Images[key].src, ">>this.column2Images[0]");
        // this.setQuestions.splice(this.setIndex, 1);
        // this.setIndex = "";
        // console.log(a, ">>a");
      ...
      arranageData() {
        ...
        this.allQuestions.forEach((element) => {
            this.setQuestions.push({ id: element.queID, src: element.question, questionOriginalID : element._id });
      ...
      getResult() {
        ...
        this.column2Images.forEach((set) => {
          ...
          if (set.id && set.aid) {
            ...
            console.log(questionID, "check", answerID);
        ...
        console.log(score, ">after result");
        ApiService.getUserById(this.userId)
          .then((res) => {
            console.log(res.data.totalPoints, ">>get totalPoints");
